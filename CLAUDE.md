...
## C�mo ejecutar Python en este equipo
...
C:\Users\Jos�MateoRoncancioMa\AppData\Local\Programs\Python\Python312\python.exe scripts\generar_cuenta_xml.py <archivo>
